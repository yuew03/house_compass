    ...
    svg
      ...
      .enter()
        ...
        .append("text")
          ...
          .attr("transform", function(d) { return "translate(" + x(d.price.date) + "," + y(d.price.price) + ")"; }) // Put the text at the position of the last point
    ...
    svg
      ...
      .enter()
        ...
        .on("click", function(d){
          ...
          currentOpacity = d3.selectAll("." + d.city).style("opacity")
